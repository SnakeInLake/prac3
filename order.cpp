...
bool processCommand(const string& command) {
    ...
    while (getline(user_lot_file, line)) {
        ...
        if (getline(ss, user_id_str, ',') &&
            ...
            cout<<"user_id_str "<<user_id_str<<endl;
            cout<<"lot_id_str "<<lot_id_str<<endl;
    ...
    for (size_t i = 1; i < updated_orders.size(); ++i) {
        ...
        if (getline(ss, existing_order_id, ',') &&
            ...
            cout << "existing_prc "<< existing_prc<<endl;

            cout << "existing_pair_id "<< existing_pair_id<<endl;
